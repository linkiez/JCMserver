...
export class ProdutoController {
  ...
  private inputEspessura: HTMLInputElement;
  private inputPeso: HTMLInputElement;
  ...
  async abrir(idProduto: string) {
    ...
    if (response.ok) {
      let criacaoProduto: any;
      let alteracaoProduto: any;
